...
def run_simulation(output_path="SimulationCodes/paper3/data/Phi_final.npy"):
    global Phi
    action_history = []
    ...
    np.save("SimulationCodes/paper3/data/action_history.npy", np.array(action_history))
